...
/**
 * This is the model class for table "prod_proyecto".
 *
 * The followings are the available columns in table 'prod_proyecto':
 * @property integer $id
...
class Proyecto extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'operacions' => array(self::HAS_MANY, 'Operacion', 'id_proyecto'),
		);
	}
	...
	public static function getProyectos($params = array())
	{
		$criteria = new CDbCriteria;
